	...
	<section class="section">
		<div class="section-header">
			...
			<div class="section-header-breadcrumb">
				<?php if($data->id == $this->session->userdata('id_user')) : ?>
					<a class="btn btn-primary mr-1 text-right" href="<?= base_url('admin/update_profil') ?>">Edit Profil</a>
				<?php endif; ?>
			</div>
		</div>
				...
				<div class="col-12">
					<div class="card profile-widget">
						<div class="profile-widget-header">
							<img alt="image" src="<?= base_url('assets/foto/' . $data->id . '.jpg') ?>" class="thumbnail profile-widget-picture" onerror="this.src='https://placehold.it/400x600';">
						...
						<div class="card-body">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<?= strtoupper($data->penugasan_tempat) ?>
								</div>
							</div>
							<div class="form-group row">
