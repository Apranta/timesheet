                ...
                <div class="row">
                    <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                        ...
                        <div class="card card-primary">
                            <div class="card-header"><h4>Pendaftaran User Payment Bujang Gadis Palembang 2020</h4></div>
                            <div class="card-body">
                                ...
                                <div class="text-center mt-4 mb-3">
                                    <div class="text-job text-muted">Sudah Punya Akun? <a href="<?=site_url("Login/customer")?>">Login</a></div>
                                </div>
                            </div>
                        </div>
